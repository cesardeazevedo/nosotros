...
import { addPermission, parseRelayList, parseRelayListToTags, READ, revokePermission, WRITE } from '../parseRelayList'
...
test('parseRelayList() from incorrect `relay` tags', () => {
  const event = fakeEvent({
    id: '1',
    kind: 10002,
    pubkey: '1',
    tags: [
      ...
      ['relay', 'wss://relay4.com', 'read'],
      ['relay', 'wss://relay5.com', 'read'],
      ['relay', 'wss://relay6.com', 'write'],
      ['relay', 'wss://relay7.com', 'write'],
      // assert duplicated
      ['relay', 'wss://relay1.com'],
      ['relay', 'wss://relay2.com', 'read'],
      ['relay', 'wss://relay3.com', 'write'],
      ['relay', 'wss://relay4.com', 'write'],
      ['relay', 'wss://relay6.com', 'write'],
    ],
  })
  const result = parseRelayList(event)
