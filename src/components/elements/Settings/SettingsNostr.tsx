  ...
  return (
    <List sx={{}}>
      ...
      <ListItem dense>
        ...
        />
        <Switch edge='end' checked={settingsStore.nostrSettings.outboxEnabled} onClick={() => settingsStore.toggleSettings('outboxEnabled')} />
      </ListItem>
      <ListItem dense sx={{ mb: 1 }}>
        <ListItemText primary={<Typography variant='subtitle1'>Relay Hints</Typography>} />
        <Switch edge='end' checked={settingsStore.nostrSettings.hintsEnabled} onChange={() => settingsStore.toggleSettings('hintsEnabled')} />
      </ListItem>
      <Divider />
      <ListSubheader sx={{ mt: 2, lineHeight: 2 }}>UI</ListSubheader>
      <ListItem dense>
        <ListItemIcon sx={{ minWidth: 32 }}><IconHeart strokeWidth='1.4' /></ListItemIcon>
        <ListItemText primary={<Typography variant='subtitle1'>Reactions</Typography>} />
        <Switch edge='end' checked={settingsStore.nostrSettings.nip25enabled} onChange={() => settingsStore.toggleSettings('nip25enabled')} />
      </ListItem>
      <ListItem dense>
        <ListItemIcon sx={{ minWidth: 32 }}><IconBolt strokeWidth='1.4' /></ListItemIcon>
